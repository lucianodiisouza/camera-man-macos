...
// The building blocks of the settings window, shared with PrimoDock's so both apps look alike.

/// CameraMan's own palette for the settings window.
enum SettingsPalette {
    /// Backdrop of visual previews: a dark studio gradient with a hint of the REC red.
    static let previewBackdrop = LinearGradient(
        colors: [Color(hex: "#1C1C22"), Color(hex: "#24242C"), Color(hex: "#3A1C22")],
        startPoint: .topLeading, endPoint: .bottomTrailing)
    static let selection = Color(hex: "#EF4444")
